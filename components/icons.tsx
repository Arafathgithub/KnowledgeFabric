...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3.75H19.5M8.25 3.75V19.5M8.25 3.75C5.466 3.75 3.75 5.466 3.75 8.25v1.5C3.75 12.534 5.466 14.25 8.25 14.25h1.5C12.534 14.25 14.25 12.534 14.25 9.75v-1.5C14.25 5.466 12.534 3.75 9.75 3.75h-1.5Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25v11.25c0 .621-.504 1.125-1.125 1.125H4.875A1.125 1.125 0 0 1 3.75 19.5V8.25" />
        <circle cx="17.25" cy="6" r="1.125" />
        <circle cx="17.25" cy="11.25" r="1.125" />
        <circle cx="17.25" cy="16.5" r="1.125" />
    </svg>
);
...
export const PanelCollapseIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const PanelExpandIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
